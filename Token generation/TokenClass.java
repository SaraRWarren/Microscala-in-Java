...
public enum TokenClass {
  ...
  VAR, OBJ, LIST, HEAD, TAIL, ISEMPTY, DEF, NIL, PRINTLN, ARRAY, STRING,
  // punctuation
  COMMA, SEMICOLON, LBRACE, RBRACE, ACCESSOR, AMPERSAND,
  // operators
  LPAREN, RPAREN, LBRACK, RBRACK, ASSIGN, OR, AND, EQ, NE, LT, LE, GT, GE, 
  PLUS, MINUS, TIMES, SLASH, MOD, NOT,
  // ids and literals
  ID, INTEGER, BOOLEAN, FLOATLIT, CHARLIT, OBJECT, VARLIT
}
